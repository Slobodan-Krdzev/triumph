...
const AccessoryItemWrapper = ({
  ...
  return (
    <div className="py-4 md:py-8 lg:py-16 border-2 border-red-500">
      ...
      <div className={`w-full m-auto flex flex-col md:flex-row mt-4 md:mt-8 lg:mt-20 border-2 border-green-500`}>
        {image1 && (
