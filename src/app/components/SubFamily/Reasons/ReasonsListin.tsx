...
const ReasonsListin = ({ reasons = [] }: ReasonsListinProps) => {
  return (
    <ol className="lg:w-6/12 md:w-10/12 w-11/12 m-auto md:mt-16 mt-4 list-decimal md:text-3xl text-xl font-semibold">
      {reasons.map((reason) => (
        <li key={reason.title} className="md:mb-8 mb-4 las:mb-0">
