...
const HeroSection = ({ video, model, slogans = []}: HeroSectionProps) => {
  return (
    <section className="relative">
        <video autoPlay muted loop className="w-full" src="/images/adventure/tigerSport660/heroVideo.webm">

        </video>
        
        <div className="absolute text-white flex flex-col items-center w-full" style={{top: '40%', left: '50%' ,transform: 'translate(-50%, -50%)'}}>
