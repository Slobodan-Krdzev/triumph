...
const TitleWithLineThrough = ({ text }: TitleWithLineProps) => {
  return (
    <div className="relative bg-inherit mt-4 md:mt-8">
      <h2 className="bg-inherit text-2xl md:text-8xl uppercase font-bold text-center relative z-10 text-black w-5/12 m-auto bg-white">
        {text}
      </h2>
      <div
