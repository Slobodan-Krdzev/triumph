      ...
      <HeroSection
        ...
        <main className="bg-white">
          ...
          <section className="bg-secondary m-auto w-11/12 md:w-10/12 lg:w-7/12 py-4 md:py-8 lg:py-16 text-center">
            <h1 className="text-3xl md:text-6xl font-semibold uppercase mb-4 md:mb-8">Новата Τiger 900 Серија</h1> 
            <SectionTitleH2 text={"Дознајте Повеќе за Tiger 900!"} color={"dark"} /> 
            <PageParagraph text={"Tiger 900 серијата е созададена за најтешките патеки и предизвикувачки авантури. Новата Tiger 900 серија е созададена комбинирајки перформанси, можности, комфорт и карактер."} />
            <PageParagraph text={"Tiger 900 серијата повторно ги подигнува стандардите во својата категорија додавајки уште повеќе спецификации."} />
