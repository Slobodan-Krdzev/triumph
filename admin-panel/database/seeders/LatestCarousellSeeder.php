...
class LatestCarousellSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        LatestCarousell::create($latestCarousel);
        LatestCarousell::create($latestCarouselTwo);
        LatestCarousell::create($latestCarouselThree);
        LatestCarousell::create($latestCarouselFour);
    }
}
