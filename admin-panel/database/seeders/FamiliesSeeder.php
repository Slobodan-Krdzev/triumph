    ...
    public function run()
    {
        $familiesData = [
            [
                "type" => "adventure",
                "mainBikeLogoImage" => [
                    "url" => "http://127.0.0.1:8000/storage/families/adventure/mainBikeLogoImage/mainBikeLogo.png",
                ...
                "familyPageBannerVideo" => "http://127.0.0.1:8000/storage/families/adventure/familyPageBannerVideo/adventureHeroVideo.webm",
                "configPageInfo" => [
                ...
                "configFamilyPageInfo" => [
                    "image" => [
                        "src" => "http://127.0.0.1:8000/storage/families/adventure/configFamilyPageInfo/configFamilyBanner.avif",
            ...
            [
                ...
                "familyPageBannerVideo" => "http://127.0.0.1:8000/storage/families/classics/familyPageBannerVideo/classicsBannerVideo.webm",
                "configPageInfo" => [
                ...
                "configFamilyPageInfo" => [
                    "image" => [
                        "src" => "http://127.0.0.1:8000/storage/families/classics/configFamilyPageInfo/configFamilyBanner.avif",
                ...
                "grayCaro" => [
                    [
                        ...
                        "image" => "http://127.0.0.1:8000/storage/families/classics/grayCaro/classicsSlide1.avif"
                    ],
                    [
                        "id" => "carouselItem2",
                        ...
                        "image" => "http://127.0.0.1:8000/storage/families/classics/grayCaro/classicsSlide2.avif"
                    ],
                    [
                        "id" => "carouselItem3",
                        ...
                        "image" => "http://127.0.0.1:8000/storage/families/classics/grayCaro/classicsSlide3.avif"
                    ],
                    [
                        "id" => "carouselItem4",
                        ...
                        "image" => "http://127.0.0.1:8000/storage/families/classics/grayCaro/classicsSlide4.avif"
                    ],
                    [
                        "id" => "carouselItem5",
                        ...
                        "image" => "http://127.0.0.1:8000/storage/families/classics/grayCaro/classicsSlide5.avif"
                    ]
                ]
            ],
            [
                ...
                "familyPageBannerVideo" => "http://127.0.0.1:8000/storage/families/roadsters/familyPageBannerVideo/roadsterHeroVideo.webm",
                "configPageInfo" => [
                ...
                "configFamilyPageInfo" => [
                    "image" => [
                        "src" => "http://127.0.0.1:8000/storage/families/roadsters/configFamilyPageInfo/configFamilyBanner.avif",
                        "alt" => "Adventure Bikes Banner"
                    ]
                ],
                "audioSection" => [
                    "audio" => "http://127.0.0.1:8000/storage/families/roadsters/audioSection/audio.mp3",
                    ...
                    "logo" => "http://127.0.0.1:8000/storage/families/roadsters/audioSection/logoAudioSection.png"
                ]
            ],
            [
                "type" => "rocket-3",
                ...
                "configFamilyPageInfo" => [
                    "image" => [
                        "src" => "http://127.0.0.1:8000/storage/families/rocket-3/configFamilyPageInfo/configFamilyBanner.avif",
                        "alt" => "Adventure Bikes Banner"
                    ]
                ]
            ],
            [
                "type" => "sport",
                "familyPageBannerDesc" => "Мотори кои ги менуваат правилата за 'Naked Bike'. Препознатливите 3-цилиндрични мотори на Triumph се дизајнирани за моќност, вртежен момент и моментален одговор.",
                "familyPageBannerVideo" => "http://127.0.0.1:8000/storage/families/sport/familyPageBannerVideo/familyPageBannerVideo.webm",
                "configPageInfo" => [
                    "link" => "/configure/families/sport"
                ],
                "configFamilyPageInfo" => [
                    "image" => [
                        "src" => "http://127.0.0.1:8000/storage/families/sport/configFamilyPageInfo/configPageBannerImage.jpg",
                ...
                "grayCaro" => [
                    [
                        ...
                        "image" => "http://127.0.0.1:8000/storage/families/sport/grayCaro/caro1.avif"
                    ],
                    [
                        "id" => "carouselItem2",
                        "title" => "Технологија",
                        ...
                        "image" => "http://127.0.0.1:8000/storage/families/sport/grayCaro/caro2.avif"
                    ],
                    [
                        "id" => "carouselItem3",
                        ...
                        "image" => "http://127.0.0.1:8000/storage/families/sport/grayCaro/caro3.avif"
                    ],
                    [
                        "id" => "carouselItem4",
                        "title" => "Целосен Пакет",
                        ...
                        "image" => "http://127.0.0.1:8000/storage/families/sport/grayCaro/caro4.avif"
                    ],
                    [
                        "id" => "carouselItem5",
                        ...
                        "image" => "http://127.0.0.1:8000/storage/families/sport/grayCaro/caro5.avif"
                    ]
                ]
            ],
            [
                "type" => "off-road",
                "familyPageBannerDesc" => null,
                "familyPageBannerVideo" => "http://127.0.0.1:8000/storage/families/off-road/familyPageBannerVideo/familyBannerVideo.webm",
                "configPageInfo" => [
                ...
                "configFamilyPageInfo" => [
                    "image" => [
                        "src" => "http://127.0.0.1:8000/storage/families/off-road/configFamilyPageInfo/offRoadConfigBanner.avif",
                ...
                "grayCaro" => [
                    [
                        ...
                        "title" => "Три-Цилиндрична Моќност",
                        "desc" => "Екслозивен напад на низок обртај, возбудлив среден опсег и импресивен врв со импресивен звук од три-цилиндри мотор на Дејтона, го понудува најдоброто од сите светови.",
                        "image" => "http://127.0.0.1:8000/storage/families/off-road/grayCaro/caro1.avif"
                    ],
                    [
                        "id" => "carouselItem2",
                        "title" => "Технологија",
                        "desc" => "Технологијата фокусирана на возачот овозможува целосна контрола врз моторот. Daytona нуди три режими на возење (спорт, пат и дожд) и притоа ја оптимизираа реакцијата на гас, поседува ABS и контролата на тракцијата за условите, а најсовремените функции за активна безбедност, како што е предупредувањето за итно забавување, овозможуваат да се фокусирате на возењето.",
                        "image" => "http://127.0.0.1:8000/storage/families/off-road/grayCaro/caro2.avif"
                    ],
                    [
                        "id" => "carouselItem3",
                        "title" => "Фокусирана на Патиштата",
                        "desc" => "Лесно управување и интуитивен спортски одговор, совршено избалансираната рамка, суспензијата со врвен квалитет и природната ергономија инспирираат доверба во секое возење.",
                        "image" => "http://127.0.0.1:8000/storage/families/off-road/grayCaro/caro3.avif"
                    ],
                    [
                        "id" => "carouselItem4",
                        "title" => "Целосен Пакет",
                        "desc" => "Водечкиот сервисен интервал од 16.000 километри во класата, двегодишната гаранција за неограничени километри и високата вредност за препродажба нудат најдобра вредност во својата класа.",
                        "image" => "http://127.0.0.1:8000/storage/families/off-road/grayCaro/caro4.avif"
                    ],
                    [
                        "id" => "carouselItem5",
                        "title" => "Можност за управување со A2 Возачка Категорија",
                        "desc" => "Новите и помладите возачи ограничени на А2 лиценца сè уште можат да уживаат во Daytona 660. Вашиот продавач на Triumph може да постави специјален држач за APS и програма за моторот што ја ограничува коњската сила на 35 kW.",
                        "image" => "http://127.0.0.1:8000/storage/families/off-road/grayCaro/caro5.avif"
                    ]
                ]
            ]
        ];
