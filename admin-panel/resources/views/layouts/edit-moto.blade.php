<x-app-layout>
    ...
    <div class="px-8 mt-10">
        ...
        <form action="{{ route('update-moto', $moto->id) }}" method="POST" class="flex flex-col">
            ...
            <label for="bikeCollorPalletteGallery[default]">Default Color:</label>
            <input type="text" name="bikeCollorPalletteGallery[default]"
                value="{{ old('bikeCollorPalletteGallery.default', isset($moto) ? $moto->bikeCollorPalletteGallery['default'] : '') }}"
                required>
