        ...
        <div class="p-20 mb-10">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <button><a href="{{ route('create-latest-carousel') }}" class="w-full bg-lime-200 shadow rounded p-4 block">Add Latest Carousel</a></button>
                </table>
            </div>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-10">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <button><a href="{{ route('create-main-carousel') }}" class="w-full bg-lime-200 shadow rounded p-4 block">Add Main Carousel</a></button>
                </table>
            </div>
        </div>
