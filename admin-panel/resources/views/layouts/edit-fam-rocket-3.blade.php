<x-app-layout>
    ...
    <div class="px-8 mt-10 w-8/12">
        ...
        <form action="{{ route('update-fam-rocket-3', $famRocket3->id) }}" method="POST" class="flex flex-col">
            @csrf
            @method('PUT')
            <h1 class="font-bold text-4xl">Family Page of <span class="capitalize text-red-500">{{$famRocket3->type}}</span></h1>
            <hr class="my-3 w-100">
                ...
                <input type="text" id="familyPageBannerVideo" name="familyPageBannerVideo" value="{{ $famRocket3['familyPageBannerVideo'] }}">
                @endif
                ...
                <input type="text" id="configPageLink" name="configPageLink" value="{{ $famRocket3['configPageInfo']['link'] }}">
                ...
                <input type="text" id="configFamilyPageImageSrc" name="configFamilyPageImageSrc" value="{{ $famRocket3['configFamilyPageInfo']['image']['src'] }}">


                <label for="configFamilyPageImageAlt">Config Family Page Image Alt:</label>
                <input type="text" id="configFamilyPageImageAlt" name="configFamilyPageImageAlt" value="{{ $famRocket3['configFamilyPageInfo']['image']['alt'] }}">
