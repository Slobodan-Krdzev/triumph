                    ...
                    @if ($moto->category == 'adventure')
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('edit-motorcycle', ['id' => $moto->id, 'category' => $moto->category]) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                    Edit
                                </a>
                            </td>
                        </tr>
                ...
                <tbody>
                    ...
                    @if ($moto->category == 'classics')
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('edit-motorcycle', ['category' => $moto->category, 'id' => $moto->id]) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                    Edit
                                </a>
                            </td>
                        </tr>
